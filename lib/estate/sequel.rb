...
module Estate
  module Sequel
    ...
    def setup_callbacks(base)
      base.class_eval do
        def validate
          ...
          from_state, to_state = column_change(:state)
          Estate::Sequel.validate_state_changes(self, from_state, to_state)
        end
      end
    end
    ...
    def add_error(instance:, message:, attribute: :base) # TODO: remove base
